...
export default function DeadlineModal({ deadline, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Modal Header */}
        <div className="flex items-start justify-between p-4 sm:p-6 border-b border-slate-100 bg-slate-50/70 rounded-t-2xl">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-extrabold text-slate-900 tracking-tight pr-6">
              {examName}
            </h2>
          </div>
          <button
        ...
        <div className="p-4 sm:p-6 space-y-5">
          ...
          <div className="rounded-xl p-4 bg-slate-900 text-slate-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs tracking-wide shadow-md transition-all w-full sm:w-auto shrink-0"
            >
        ...
        {/* Modal Footer */}
        <div className="p-3 sm:p-4 border-t border-slate-100 bg-slate-50/50 rounded-b-2xl flex justify-end">
          <button
            onClick={onClose}
            className="w-full sm:w-auto px-5 py-2.5 sm:py-2 rounded-xl text-xs font-bold text-slate-700 bg-slate-200 hover:bg-slate-300 transition-colors cursor-pointer text-center"
          >
            Close
          </button>
        </div>
