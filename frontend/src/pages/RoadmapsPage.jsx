  ...
  const content = (
    <div className="space-y-6">
      ...
      <SectionCard className="overflow-hidden border border-slate-800 bg-gradient-to-br from-slate-950 via-slate-900 to-indigo-950 text-white shadow-2xl">
        <div className="grid gap-5 sm:gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/20 px-3 py-1 text-[11px] sm:text-xs font-bold uppercase tracking-[0.2em] text-blue-200">
            ...
            <p className="mt-2 max-w-xl text-xs sm:text-sm leading-relaxed text-blue-100/90">
              Explore verified Indian education pathways across degrees, polytechnics, entrance exams, and career domains.
            </p>
          </div>

          <div className="flex flex-col gap-2.5 sm:gap-3 rounded-2xl sm:rounded-[1.8rem] border border-white/15 bg-white/10 p-4 sm:p-5 backdrop-blur">
            <div className="flex items-center justify-between">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-blue-200">
                Current View Mode
              </span>
              <span className="rounded-full bg-blue-500/30 px-2.5 py-0.5 text-[11px] sm:text-xs font-extrabold text-white">
                {activeTab === "12th"
                  ? "Class 12 Master"
                  : activeTab === "10th"
                  ? "Class 10 Master"
      ...
      <SectionCard className="p-2.5 sm:p-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-2 w-full sm:w-auto">
            ...
            {(!user || user.classLevel !== "10") && (
              <button
                ...
                className={`flex items-center justify-center gap-2 rounded-xl sm:rounded-2xl px-4 py-2.5 sm:px-5 sm:py-3 text-xs sm:text-sm font-extrabold transition cursor-pointer w-full sm:w-auto ${
                  activeTab === "12th"
          ...
          {!user && (
            <Link to="/login" className="text-xs font-bold text-blue-600 hover:underline text-center sm:text-left py-1">
