...
export default function CourseDetailsPage() {
  ...
  return (
    <div className="space-y-6">
      <SectionCard>
        <p className="text-xs sm:text-sm font-semibold uppercase tracking-[0.2em] text-blue-800">{course.level}</p>
        <h1 className="mt-3 text-2xl sm:text-4xl font-black text-slate-950 break-words">{course.name}</h1>
        <p className="mt-4 max-w-3xl text-xs sm:text-sm leading-6 sm:leading-7 text-slate-600">{course.overview}</p>
      </SectionCard>
