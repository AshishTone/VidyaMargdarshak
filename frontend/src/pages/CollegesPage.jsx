...
export default function CollegesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-7 border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-5">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:w-auto md:inline-flex bg-slate-100 p-1.5 rounded-2xl text-xs sm:text-sm font-medium border border-slate-200/60 gap-1 sm:gap-0">
          <button
            type="button"
            onClick={() => setActiveTab('recommended')}
            className={`flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 rounded-xl transition-all cursor-pointer ${
          ...
          >
            ...
            <span className="truncate">Personalized Recommendations</span>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <span className="truncate">Directory Explorer</span>
          </button>
        </div>
      </div>
