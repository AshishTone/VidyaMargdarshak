...
export default function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-3.5 py-6 sm:px-4 sm:py-8">
      <div className="panel w-full max-w-lg rounded-2xl sm:rounded-[2rem] p-5 sm:p-8">
        ...
        <p className="mt-2 text-xs font-semibold uppercase tracking-[0.25em] sm:tracking-[0.3em] text-blue-800">Sign up</p>
        <h1 className="mt-2 sm:mt-3 text-2xl sm:text-3xl font-bold text-slate-950">Create your student profile</h1>
        ...
        <form className="mt-6 sm:mt-8 grid gap-3.5 sm:gap-4" onSubmit={handleSubmit}>
          <input
