...
export default function CollegeCard({ college, onSelectCollege, onToggleSaveCollege, isSaved }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all p-4 sm:p-5 flex flex-col justify-between group">
      <div>
        {/* Header Badges */}
