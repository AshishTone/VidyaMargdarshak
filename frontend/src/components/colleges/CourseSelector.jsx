    ...
    <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="relative" ref={pathwayRef}>
          ...
          {pathwayDropdownOpen && (
            <div className="absolute left-0 top-full mt-2 z-40 w-full min-w-[240px] max-w-[calc(100vw-2.5rem)] max-h-72 overflow-y-auto rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl space-y-1 animate-in fade-in zoom-in-95">
