      ...
      <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          ...
          <select
            ...
            className="w-full sm:w-auto bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 sm:py-1.5 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-3 sm:inline-flex bg-slate-100 p-1 rounded-xl text-xs font-medium w-full sm:w-auto">
          <button
            type="button"
            onClick={() => setViewMode('split')}
            className={`flex items-center justify-center gap-1 px-3 py-1.5 rounded-lg transition-all cursor-pointer ${
        ...
        <div>
          {viewMode === 'split' && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
              ...
              <div className="lg:col-span-5 sticky top-20 h-[320px] sm:h-[550px]">
                <CollegeMap
                  userLocation={userLocation}
                  colleges={colleges}
                  onSelectCollege={setSelectedCollege}
