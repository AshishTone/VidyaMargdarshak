...
export default function SearchSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-8 border border-slate-200 shadow-sm">
        ...
        <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder={
                is10th
                  ? 'Search by college name, diploma stream, or district...'
                  : 'Search by college name, course, or university...'
              }
              value={query}
          ...
          <button
            type="submit"
            className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold transition-all shadow-md shadow-blue-600/20 cursor-pointer text-center"
          >
            Search
          </button>
        </form>
