...
export default function CollegeMap({ userLocation, colleges = [], onSelectCollege }) {
  ...
  return (
    <div className="relative w-full h-full min-h-[300px] sm:min-h-[420px] rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-slate-100">
      <div ref={mapContainerRef} className="w-full h-full min-h-[300px] sm:min-h-[420px]" />
